...
function opts(){
 ...
 const baseFreeCountries=[
   ...
   $("freeHK").checked?"HK":"",$("freeTW").checked?"TW":"",$("freeMY").checked?"MY":"",
   $("freeIN").checked?"IN":"",$("freeKR").checked?"KR":"",$("freeDE").checked?"DE":""
 ].filter(Boolean);
 return {
...
function buildClash(){
 ...
 if(o.customIpEnabled&&!o.freeEnabled&&o.customIpRules.some(r=>["US","JP","SG","HK","TW","MY","IN","KR","DE","FREE"].includes(r.target))){
